...
dataset_url = f"https://s3.amazonaws.com/nyc-tlc/trip+data/{csv_file}"
...
with DAG(
    ...
    download_dataset_task = BashOperator(
        ...
        bash_command=f"curl -sSL {dataset_url} > {path_to_local_home}/{csv_file}"
    )
    ...
    bigquery_external_table_task = BigQueryCreateExternalTableOperator(
        ...
        table_resource={
            "tableReference": {
                ...
                "tableId": "yellow_tripdata_2019_01",
            },
